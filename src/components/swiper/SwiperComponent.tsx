...
export default function SwiperComponent({
  ...
  return (
    <div className={"relative "}>
      ...
      <div className="flex gap-2 justify-end py-4 relative z-20 md:hidden">
        <button
          className={
            "rounded-full bg-[#3FA9F5] h-7 w-7 md:h-10 flex items-center justify-center md:w-10  "
          }
          onClick={onPrev}
          style={{
            cursor: !showPrev ? "not-allowed" : "pointer",
        ...
        <button
          className={
            "rounded-full bg-[#3FA9F5] h-7 w-7  md:h-10 z-[600] flex items-center justify-center md:w-10  "
          }
          onClick={onNext}
          style={{
            cursor: !showNext ? "not-allowed" : "pointer",
