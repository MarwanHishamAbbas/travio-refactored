...
export default function FeatureSection({
  ...
  if (data?.type == "small") {
    return (
      <MaxWidth
        className={
          "text-center overflow-hidden  px-5 md:px-0   pt-[50px] md:pt-[84px] text-[#140D31] relative w-full "
        }
      >
        {/* {data.title && ( */}
        <>
        ...
        <div className="flex mx-auto flex-col md:flex-row  md:justify-between  mt-[54px] md:mt-[74px]   gap-[60px] md:gap-[150pxs] w-full max-w-[400px]  md:max-w-none">
          ...
          <div className="w-[180px] h-[120px] md:h-[132px] md:w-[300px] absolute right-0 md:bottom-32 -bottom-12"></div>
  ...
  return (
    <MaxWidth
      className={
        "bg-lightBlue font-satoshi md:px-[29px] px-5 text-center py-5 md:py-2  md:rounded-[16px] rounded-none"
      }
    >
      {/* {data.title && ( */}
      <div className="flex md:items-start  items-center justify-evenly md:justify-start flex-col text-2xl font-bold w-fit mx-auto">
