...
const Breadcrumbs = ({
  ...
  return (
    <MaxWidth className="w-full font-satoshi my-2 md:my-5  mx-auto max-w-7xl px-4  tracking-tight flex md:items-center gap-1 text-[12px] max-md:leading-5  md:text-base  font-normal leading-tight md:leading-normal">
        ...
        >
          ...
          >
            <path
              ...
              className={i === lastIndex ? "fill-primary" : "fill-darkBlue"}
            />
          </svg>
