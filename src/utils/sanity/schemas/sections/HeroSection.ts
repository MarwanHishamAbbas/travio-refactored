import {
  defineArrayMember,
  defineField,
  defineField as defineType,
} from "sanity"

import { Image, Link, TextCursorInput, TextCursorInputIcon } from "lucide-react"
...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "subtitle",
      title: "Subheading",
      icon: TextCursorInputIcon as any,
    ...
    defineField({
      ...
      title: "Scores",
      description:
        "Ratings for the hero section to display instead of the search input field",
      type: "array",
