...
import { getTailorPage, getTailorPageSeo } from "@/query/tailor"
import dynamic from "next/dynamic"

const TailorYourTourPage = dynamic(
  () => import("@/components/pages/TrailYourTour")
)
...
export default async function Index({ params }: any) {
  ...
  return (
    <>
      <TailorYourTourPage language={lang} data={tailorPage} />
    </>
  )
}
