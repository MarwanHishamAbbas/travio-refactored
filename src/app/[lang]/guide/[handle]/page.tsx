...
import { getGuidePage, getGuidePageSeo } from "@/query/guide"
import dynamic from "next/dynamic"
const GuidePage = dynamic(() => import("@/components/pages/guide/GuidePage"))
...
const Index = async ({ params }: any) => {
  ...
  return <GuidePage language={lang} pageData={guidePage} />
}
